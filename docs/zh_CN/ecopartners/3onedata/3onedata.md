...
在三旺高性价比的硬件产品中搭载 EMQ 的高性能工业协议网关软件 GridBeat 后，并与云端的 EMQ 集群无缝桥接，形成了完整的工业互联网解决方案。让您的数据基础设施触达最后一公里的角落，彻底解决连接的烦恼。助力企业数字化转型和产业升级。

<img src="./assets/3one-scenario1.png" alt="3one-scenario1" style="zoom:60%;" />

## 价值和优势

三旺在各类工业组网场景中都有丰富经验，其丰富的产品种类和网络接口覆盖了 Ethernet、Modbus、EtherCAT、WIFI、4G、5G、POE、LORA、NB-IOT 等各类组网需求。三旺网关优异的硬件资源和网络能力配置配合 GridBeat 2.0 的内置的高性能总线和丰富的工业 PLC 协议支持，能够应对各类工业场景的数字化需求。
