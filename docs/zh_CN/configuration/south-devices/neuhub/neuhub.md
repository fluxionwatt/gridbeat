...
GridBeat HUB 插件通过 TCP 协议访问安装有 GridBeatHUB 程序的主机。

## 设备设置

| 字段           | 说明                       |
| -------------- | -------------------------- |
| host           | GridBeatHUB IP 地址          |
| port           | GridBeatHUB 端口, 默认 17889 |
| type           | 节点类型                   |
| node           | 节点名称                   |
...
## GridBeatHUB Windows 程序
由于一些协议的平台受限，所以需要一个中间转换程序，GridBeatHUB 程序就是进行的转换功能。安装包请联系支持人员获取。
