...
本节主要介绍 GridBeat 作为 Client，Modbus Slave 作为 Server 时，GridBeat 与 Modbus Slave 的相关配置。

GridBeat 作为 Client，主动向 Modbus Slave 发起连接请求，用户需要保证 GridBeat -> Modbus Slave 的网络连通性。
...
<img src="../assets/gridbeat-client-config.png" alt="image-20230711160257212" style="zoom:50%;" />
