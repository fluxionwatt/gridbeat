...
GridBeat EtherNet/IP (CIP) 插件主要用于支持 EtherNet/IP 协议的设备。
...
点击插件卡片或插件列，进入**设备配置**页。配置 GridBeat 与设备建立连接所需的参数，下表为 EtherNet/IP (CIP) 相关的配置项。
...
使用 PLC 软件连接到 PLC，PLC 上点位的名称即为 GridBeat 中点位地址。
