...
本节将演示如何通过 GridBeat OPC UA 插件连接 Industrial Gateway OPC Server。
...
2. GridBeat 新增南向 OPC UA 设备，打开 **设备配置**，填写目标 Server 的 **端点 URL**，无需填写用户名/密码，无需添加证书/密钥，启动设备连接。
...
2. GridBeat 新增南向 OPC UA 设备，打开 **设备配置**，填写目标 Server 的**端点 URL**，无需填写用户名/密码，添加证书/密钥。
