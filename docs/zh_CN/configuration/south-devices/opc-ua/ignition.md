...
本节将演示如何通过 GridBeat OPC UA 插件连接 Ignition。
...
2. GridBeat 新增南向 OPC UA 设备，打开 **设备配置**，
...
4. 打开 Ignition 的管理界面 **Config** -> **OPC UA** -> **Security** -> **Server**，将 **Quarantined Certificates** 列表中的 GridBeatClient 证书设置为信任。
