...
您可通过 GridBeat SparkPlugB 北向应用连接 Ignition 平台。
...
1. 在 GridBeat **北向应用** 中添加一个 Sparkplug B 应用。
...
3. 在软件界面中找到 **Tag Browser** 并选择 **MQTT Engine**，展开 **Edge Nodes\Factory1\GridBeat1\opcua-kepserver\test** 可以看到即时上传的测点数据。
