...
GridBeat 支持 MQTT 插件作为其数据汇聚上报的方式之一。 GridBeat Azure IoT 插件基于 [MQTT 插件]，提供对 Azure IoT Hub 的便捷接入。
...
[使用 GridBeat 将数据桥接到 Azure IoT Hub](./example.md) 教程演示了如何使用 Azure IoT 插件连接 Azure IoT Hub 。
