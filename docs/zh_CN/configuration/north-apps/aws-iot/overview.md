...
GridBeat 支持 MQTT 插件作为其数据汇聚上报的方式之一。 GridBeat AWS IoT 插件基于 [MQTT 插件]，提供对 AWS IoT Core 的便捷接入。
...
- **主题**：指定上报主题，例如 /gridbeat/mqtt/upload。
...
[使用 GridBeat 将数据桥接到 AWS IoT](./example.md) 教程演示了如何使用 AWS IoT 插件连接 AWS IoT Core。
