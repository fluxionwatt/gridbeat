...
The IIoT platform or any other monitoring application can effectively monitor and control GridBeat devices by utilizing the provided HTTP APIs. The key features of these APIs are:
...
[Control Commands:](./rw.md) The APIs also facilitate sending control commands to the GridBeat devices, enabling the platform to remotely control and manage the devices. This allows for seamless management of device functionalities.
...
[JWT Authentication:](./jwt.md) The APIs employ JWT authentication, ensuring secure communication and authentication between the IIoT platform or monitoring application and the GridBeat devices. This enhances the overall security of the system.
