...
GridBeat currently supports the following northbound nodes:
...
- **[Monitor](./monitor/overview.md)**: GridBeat creates a Monitor singleton node at startup to monitor the running status of GridBeat. You can see the Monitor node in the **North Apps** tab on the dashboard.
