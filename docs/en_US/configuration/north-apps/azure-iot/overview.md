...
GridBeat supports MQTT as one of its communication protocols. The GridBeat Azure IoT plugin is based on the [MQTT plugin] to provide easy access to Azure IoT .
...
[Bridging Data to Azure IoT Hub using GridBeat](./example.md) demonstrates how to use the Azure IoT plugin to connect to Azure IoT Hub.
