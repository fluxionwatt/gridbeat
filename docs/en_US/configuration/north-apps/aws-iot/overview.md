...
GridBeat supports MQTT as one of its communication protocols. The GridBeat AWS IoT plugin is based on the [MQTT plugin] to provide easy access to AWS IoT Core.
...
[Bridging Data to AWS IoT using GridBeat](./example.md) demonstrates how to use the AWS IoT plugin to connect to AWS IoT Core.
