# Using UaExpert to Connect to GridBeat OPC UA Server

This section demonstrates how to use UaExpert (a popular OPC UA client) to connect, trust certificates, subscribe to variables, and write values, to verify the GridBeat OPC UA Server configuration.
