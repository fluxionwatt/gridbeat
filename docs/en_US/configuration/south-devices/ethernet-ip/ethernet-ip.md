...
You can use GridBeat EtherNet/IP (CIP) plugin to connect EtherNet/IP devices.
...
Connect to PLC with PLC software, the name of the point on the PLC is the address of the point in GridBeat.
