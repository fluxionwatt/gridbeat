...
The GridBeat HollySys Modbus TCP plugin is for collecting HollySys PLC tags using the Modbus TCP protocol,
...
| **IP Address** | The IP address of the device when using TCP connection with GridBeat as the client. |
| **Port** | The port number of the device when using TCP connection with GridBeat as the client. |
...
The GridBeat HollySys Modbus TCP plugin frees users from details of the address mapping, and designates the PLC data unit name as the **ADDRESS**.
