...
The GridBeat HollySys Modbus RTU plugin is for collecting HollySys PLC tags using the Modbus RTU protocol,
...
The GridBeat HollySys Modbus RTU plugin frees users from details of the address mapping, and designates the PLC data unit name as the **ADDRESS**.
