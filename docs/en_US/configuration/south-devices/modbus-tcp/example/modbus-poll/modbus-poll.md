...
![gridbeat-tcp-server-config](../assets/gridbeat-tcp-server-config-en.png)
...
* Enter **Connection -> Connect**, choose a connection method based on actual circumstances(this example is Modbus TCP/IP) and set up the connection parameters(the IP address and listening port of the GridBeat), clicking **OK** will complete the configuration, as shown in the figure below.
