...
This section introduces how to connect the FX5U using the GridBeat Mitsubishi 3E plugin.
...
1. In GridBeat, add a Mitsubishi 3E device under **Configuration** -> **South Devices**. 
...
1. Set the UDP protocol in the PLC, **Protocol** select UDP, **Port No.** fill in the PLC listening port, and **IP Address** fill in the IP address of the host where the GridBeat is running.
![fx5u7](./assets/fx5u_en7.jpg)

2. Configure the GridBeat UDP transport mode, **Transport Mode** select UDP, and use the default port number 52001 for the UDP source port.
