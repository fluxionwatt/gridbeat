...
The GridBeat HUB plugin accesses hosts running the GridBeatHUB program via TCP protocol.

## Device Settings

| Field          | Description                        |
| -------------- | ---------------------------------- |
| host           | GridBeatHUB IP address               |
| port           | GridBeatHUB port (default: 17889)    |
| type           | Node type                          |
| node           | Node name                          |
...
## GridBeatHUB Windows Program
Due to platform limitations of some protocols, an intermediate conversion program is required. The GridBeatHUB program serves this purpose. Contact support to obtain the installation package.
