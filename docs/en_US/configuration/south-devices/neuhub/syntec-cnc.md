...
GridBeat can use the GridBeat HUB driver and GridBeatHUB Windows program to indirectly access the SYNTEC CNC system, enabling real-time collection of various device operation data, including program names, spindle override, operation status, PLC points, parameters, global variables, etc.
