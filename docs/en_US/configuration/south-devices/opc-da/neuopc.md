...
8. By double-clicking on the Name column of the neuopc site list, the corresponding site name can be copied to the clipboard and then pasted in the tag form of gridbeat.
    ![](./assets/neuopc-connect1-1.png)

  ![](./assets/neuopc-connect1-2.png)

## GridBeat OPC UA setting

1. Add an opcua device to the gridbeat southbound device manager.
