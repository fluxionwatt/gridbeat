...
This section mainly describes the configuration of GridBeat and Modbus Slave when GridBeat serves as Client and Modbus Slave serves as Server.

As a Client, GridBeat initiates connection requests to Modbus Slave actively. The user needs to ensure the network connectivity of GridBeat -> Modbus Slave.
...
![gridbeat-rtu-client-config](./assets/gridbeat-rtu-client-config-en.png)
