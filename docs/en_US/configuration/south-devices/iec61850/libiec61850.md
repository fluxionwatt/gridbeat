...
libiec61850 is an open-source (GPLv3) implementation of an IEC 61850 client and server library implementing the protocols MMS, GOOSE and SV. This section introduces how to use GridBeat IEC61850 plugin to connect LibIEC61850 Server.
...
1. Adding an IEC61850 device to the GridBeat southbound device management;
