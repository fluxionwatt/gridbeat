...
This section describes how to connect the S7300 via the GridBeat Siemens MPI plug-in.
...
1. Add a Siemens MPI device to the GridBeat Southbound Device Manager. 2.
