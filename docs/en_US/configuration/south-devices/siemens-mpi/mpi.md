...
GridBeat's MPI plug-in is available for data access on S7300 and S7400 PLCs.
...
Click on the Plugin card or Plugin column to go to the **Device Configuration** page. Configure the parameters required for GridBeat to establish a connection with the device, the table below shows the plugin related configuration items.
...
After completing the plugin addition and configuration, to establish communication between the device and GridBeat, first add groups and points for the southbound driver.
