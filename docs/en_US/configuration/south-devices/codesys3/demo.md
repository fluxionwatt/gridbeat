...
- 
## Configure GridBeat Node to Connect to CODESYS V3 Simulator
...
- Go to the GridBeat **Data Monitoring**, select the corresponding device and group, and view the collected data points as shown below.
