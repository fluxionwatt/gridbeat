...
## Configure the GridBeat node to connect to the Ignition SECS/GEM Simulator
...
* Enter the GridBeat **Data Monitoring** page and select the corresponding device and group to view the collected data points, as shown in the following figure.
