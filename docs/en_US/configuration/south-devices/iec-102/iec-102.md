...
GridBeat supports obtaining relevant data from devices by calling I/II level user data.
...
After adding and configuring the plugin, to establish communication between the device and GridBeat, you need to add groups and tags to the Southbound driver.
