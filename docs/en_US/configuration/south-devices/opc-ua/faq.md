...
* OPC Server needs to set GridBeatClient in the "Trusted Clients" list to be trusted if anonymous login is not used.

* Abnormal connection, need to check whether GridBeat OPC UA device configuration is correct.

* Provide GridBeat device logs to developers to help troubleshoot issues.
