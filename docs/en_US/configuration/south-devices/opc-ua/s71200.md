...
2. GridBeat adds a new southbound OPC UA device, open **Device Configuration**, fill in the **Endpoint URL** of the target PLC, user name/password, no need to add certificate/key.
...
4. Add **Groups** and **Tags** based on the measurement point information.
   ...
   :::tip
   The **NODEID** of the Siemens S7-1200 is in digital form and the address of the GridBeat needs to be set according to the actual value.
   :::

   The data type mapping relation is as follows:

   | PLC Data Type | OPC UA Data Type | GridBeat Data Type |
   | ------------ | -------------- | --------------- |
