...
The GridBeat DLT645-2007 plugin provides connectivity with DL/T 645-2007 devices through serial ports and TCP.
...
| **Connection Mode**    | The way the driver connects to the device, the default is Client, which means that the gridbeat driver is used as the client. Options: Client, Server. |
...
You can continue to read how to use the GridBeat DLT645-2007 plugin to connect [Chint Single-phase Rail Meter](./example/connect.md) for a quick start.
