...
Panasonic's FP-XH C30T is a versatile PLC from the FP-XH series, ideal for small-to-medium automation tasks. This guide will illustrate its integration via the GridBeat Mewtocol plugin.
...
## Configure GridBeat
1. Add a Panasonic Mewtocol device to the GridBeat Southbound Device Manager.
